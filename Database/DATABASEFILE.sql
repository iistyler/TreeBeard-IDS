...
# Database: KDD2
# Generation Time: 2017-04-09 16:11:47 +0000
# ************************************************************
...
CREATE TABLE `TestData` (
  ...
  `buffer_overflow` int(11) DEFAULT '0',
  `ftp_write` int(11) DEFAULT '0',
  `guess_passwd` int(11) DEFAULT '0',
  `imap` int(11) DEFAULT '0',
  `ipsweep` int(11) DEFAULT '0',
  `a_land` int(11) DEFAULT '0',
  `loadmodule` int(11) DEFAULT '0',
  `multihop` int(11) DEFAULT '0',
  `neptune` int(11) DEFAULT '0',
  `nmap` int(11) DEFAULT '0',
  `perl` int(11) DEFAULT '0',
  `phf` int(11) DEFAULT '0',
  `pod` int(11) DEFAULT '0',
  `portsweep` int(11) DEFAULT '0',
  `rootkit` int(11) DEFAULT '0',
  `satan` int(11) DEFAULT '0',
  `smurf` int(11) DEFAULT '0',
  `spy` int(11) DEFAULT '0',
  `teardrop` int(11) DEFAULT '0',
  `warezclient` int(11) DEFAULT '0',
  `warezmaster` int(11) DEFAULT '0',
  `dos` int(11) DEFAULT '0',
  `u2r` int(11) DEFAULT '0',
  `r2l` int(11) DEFAULT '0',
  `ignoreMe` int(11) DEFAULT '0',
  `probe` int(11) DEFAULT '0',
  `normal` int(11) DEFAULT '0',
  `http_8001` int(11) DEFAULT '0',
  `aol` int(11) DEFAULT '0',
  `http_2784` int(11) DEFAULT '0',
  `harvest` int(11) DEFAULT '0',
  `mscan` int(11) DEFAULT '0',
  `apache2` int(11) DEFAULT '0',
  `dictionary` int(11) DEFAULT '0',
  `named` int(11) DEFAULT '0',
  `sendmail` int(11) DEFAULT '0',
  `xlock` int(11) DEFAULT '0',
  `xsnoop` int(11) DEFAULT '0',
  `snmpgetattack` int(11) DEFAULT '0',
  `udpstrom` int(11) DEFAULT '0',
  `httptunnel` int(11) DEFAULT '0',
  `worm` int(11) DEFAULT '0',
  `snmpguess` int(11) DEFAULT '0',
  `mailbomb` int(11) DEFAULT '0',
  `processtable` int(11) DEFAULT '0',
  `ps` int(11) DEFAULT '0',
  `xterm` int(11) DEFAULT '0',
  `eject` int(11) DEFAULT '0',
  `sqlattack` int(11) DEFAULT '0',
  `udpstorm` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table TrainData
# ------------------------------------------------------------
